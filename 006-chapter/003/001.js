...
// newCount = count++; - постфиксный инкремент (приоритет ниже: count увеличится  на 1, newCount равен неизмененному count)
// newCount = count--;
// newCount = ++count; - префиксный инкремент (приоритет выше: count увеличится на 1, newCount равен увеличенному count)
newCount = --count;
console.log(`count: ${count}; newCount: ${newCount}`);
